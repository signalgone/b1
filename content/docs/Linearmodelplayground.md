...
![Alt text]({{< resource "Linearmodelplayground/image.png" >}})

Now that we have our random variables, we fit them onto OLS.
![Alt text]({{< resource "Linearmodelplayground/image-1.png" >}})
...
![Alt text]({{< resource "Linearmodelplayground/image-2.png" >}})
...
![Alt text]({{< resource "Linearmodelplayground/image-3.png" >}})
